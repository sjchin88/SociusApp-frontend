 ...
 * @param {Object} param0 profile, messageCount, messageNotifications, openChatPage(a function)
        ...
        <div className="message-card-body">
          ...
          <div className="message-card-body-info">
            <div data-testid="info-container" className="message-card-body-info-container">
              {/* loop through the message notification list */}
...
/**
 * Define propTypes for messagesidebar
 */
