 ...
 */
const Header = () => {
  // Get the profile from the redux store using useSelector
  ...
  /**
   * function to logout user which
   * 1. setLoggedIn to false
   * 2. Call Utils.clearStore() function
   * 3. Call userService.logoutUser()
  ...
  /**
   * Set the value of the dropdown menu for setting
   */
  useEffectOnce(() => {
    ...
    <>
      {!profile ? (
        ...
        <div className="header-nav-wrapper" data-testid="header-wrapper">
          {/* display MessageSidebar if isMessageActive */}
          {isMessageActive && (
            <div ref={messageRef}>
              <MessageSidebar
                profile={profile}
          ...
          <div className="header-navbar">
            ...
            <ul className="header-nav">
              <li
                ...
                // if we click on the notification dots, will close the messageSidebar
                onClick={() => {
              ...
              <li
                className="header-nav-item active-item"
                // if we click on the message dots, will open the messageSidebar
                onClick={() => {
