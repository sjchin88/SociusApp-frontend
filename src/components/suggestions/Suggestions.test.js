...
/**
 * Simulate three username, add to suggestions
 * and check if the suggestion components have the required items
 */
describe('Suggestions', () => {
  ...
  /**
   * Simulate list of more than 10 users
   * and check if viewmore is present
   */
