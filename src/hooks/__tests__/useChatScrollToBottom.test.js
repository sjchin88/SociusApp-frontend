...
// forwardRef allow parent component to pass ref down to the children
...
// Defining datalist to be passed to the container
...
describe('useChatScrollToBottom', () => {
  ...
  describe('scroll', () => {
    ...
    it('should have zero scrollTop value', async () => {
      ...
      hook.rerender(dataList);
      // scrollTop will be equal to zero as we dont have scrollHeight and clientHeight
    ...
    it('should have scrollTop value greater than zero', async () => {
      ...
      dataList = [...dataList, ...dataList2];
      hook.rerender(dataList);
      // scrollTop will be equal to 50 as we have scrollHeight and clientHeight
